...
def borough_name(boroughName):
    ...
    print bdata
    return render_template("recycle.html", recycleday=bdata.recycling_day, frequency=bdata.frequency, generalwastedays=bdata.general_waste_days, generalwastefrequency=bdata.general_waste_frequency, foodwastedays=bdata.food_waste_days, foodwastefrequency=bdata.food_waste_frequency, materialsprovided=bdata.materials_provided, contact=bdata.contact)
